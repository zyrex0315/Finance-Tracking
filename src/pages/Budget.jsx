      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="mt-4 h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
            <div 
              className={`h-full rounded-full ${
                overallPercentage > 90 ? 'bg-red-500 dark:bg-red-700' : overallPercentage > 75 ? 'bg-amber-500 dark:bg-amber-700' : 'bg-green-500 dark:bg-green-700'
              }`}
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
          ...
          <div className="mt-4 h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
            <div 
              className={`h-full rounded-full ${
                totalRemaining < 0 ? 'bg-red-500 dark:bg-red-700' : 'bg-green-500 dark:bg-green-700'
              }`}
